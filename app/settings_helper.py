...
DEFAULT_SETTINGS = {
    ...
    "email": "hello@aaijinursery.com",
    "address": "Plot 14, Green Valley Road, Nashik, Maharashtra, India",
    "map_embed_url": "https://www.google.com/maps?q=Nashik,Maharashtra,India&output=embed",
